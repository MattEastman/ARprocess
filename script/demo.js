...
function init() {
	...
	$.fn.scrollPath("getPath")
        ...
        .lineTo(3250, 1200, {name: "EastmanSlide"})
    
    
		// Arc up while rotating or Prototype
		.arc(3400, 1100, 500, Math.PI/2, 0, true, {rotate: Math.PI/2 })
		// Line to 'rotations'
		.lineTo(2350, -1800, {
			name: "rotations"
		})
		// Rotate in place Redesign 
		.rotate(3*Math.PI/2)
        .lineTo(2170, -350,{
			name: "rotations-rotated"
		})
		// Continue upwards to 'source' Funcding 
		.lineTo(1200, 0, {
			name: "source"
		})
		// Small arc downwards
		.arc(500, -1300, 250, 0, -Math.PI/2, true)

		//Line to 'follow' or Contact
		.lineTo(320, -1050, {
			name: "follow"
		})
